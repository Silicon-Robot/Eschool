            ...
            let theQuestions = this.state.questionOrder.map(questionIndex=>{
                ...
                return(
                    <div className="askedQuestion" key={++index}>
                        ...
                        {question.refFiles.map((id,i)=>typeof(id)==="string"?<img key={i} src={"https://dp-db.herokuapp.comteacher/questionnaire/image/"+id} style={{height: "100px",width: "100px"}} alt="uploaded"/>:null)}
                        {questionType==='QCM'?(
